...
public class ClassicInkTankModel extends AbstractInkTankModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(Splatcraft.MOD_ID, "classicinktankmodel"),
            "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition inkTank = torso.addOrReplaceChild(
                ...
                CubeListBuilder.create().texOffs(0, 19)
                        ...
                        .texOffs(20, 28)
                        .addBox(-1.5F, 2.25F, 3.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                        .texOffs(22, 32)
                        .addBox(-2.0F, 2.0F, 4.75F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
                        .texOffs(21, 35)
                        .addBox(-0.5F, 2.0F, 3.25F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
                        .texOffs(16, 19)
                        .addBox(-2.0F, 11.25F, 3.25F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                        .texOffs(20, 24)
                        .addBox(-1.5F, 11.75F, 3.75F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                        .texOffs(0, 24)
                        ...
                        .texOffs(0, 33)
                        .addBox(-1.0F, 0.75F, 4.25F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                        .texOffs(8, 34)
                        .addBox(-2.75F, 3.75F, 4.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.75F, 0.25F));
